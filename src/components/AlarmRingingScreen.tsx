    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center z-10 max-w-lg mx-auto w-full my-auto">
        ...
        <div className="relative mb-8">
          <div className="w-24 h-24 rounded-full bg-cyan-500 text-[#050508] flex items-center justify-center shadow-2xl shadow-cyan-500/20 active:scale-95 transition-transform duration-100">
            <Bell className="w-12 h-12 animate-swing" />
          </div>
          <span className="absolute inset-0 rounded-full border-4 border-cyan-500 animate-ping opacity-30" />
        </div>

        {/* Large Time Indicator */}
        <h2 className="text-6xl md:text-7xl font-extrabold tracking-tighter text-white font-mono mb-4 text-glow-cyan">
          {activeAlarm.time}
        </h2>

        {/* Action Title / Custom message */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 w-full shadow-lg backdrop-blur-md">
          ...
          <p className="text-2xl font-bold text-cyan-100 leading-snug">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 z-10 w-full max-w-lg mx-auto">
        ...
        <button
          ...
          onClick={onDismiss}
          className="w-full sm:w-1/2 py-4 px-6 rounded-2xl bg-cyan-500 hover:bg-cyan-600 active:scale-[0.98] transition-all font-black text-center text-[#050508] flex items-center justify-center gap-2 shadow-xl shadow-cyan-500/10"
        >
